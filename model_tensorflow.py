...
# Hàm chuẩn hóa tiếng Việt (ví dụ, bạn có thể tùy chỉnh thêm nếu cần)
def standard_vi(text):
    # Xử lý văn bản tiếng Việt, loại bỏ các dấu câu, ký tự không cần thiết
    # Bạn có thể thêm các bước xử lý tùy chỉnh khác
    return text.lower()

# Hàm chuẩn hóa tiếng Anh
def standard_en(text):
    # Xử lý văn bản tiếng Anh, loại bỏ các dấu câu, ký tự không cần thiết
    return text.lower()
